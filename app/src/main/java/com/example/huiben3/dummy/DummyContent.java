package com.example.huiben3.dummy;

import com.example.huiben3.FolderScanService;
...
public class DummyContent {
    ...
    private static FolderScanService folderScanService = new FolderScanService();
    private static List<Book> books = folderScanService.scan();
